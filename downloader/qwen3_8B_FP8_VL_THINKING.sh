...
SNAPSHOT_DIR="$CKPTDIR/models--Qwen--Qwen3-VL-8B-Thinking-FP8/snapshots/main"
...
# Веса модели
echo "🚀 Скачиваем 2 safetensors файла (~10.6GB)..."
for i in 01 02; do
...
echo "🎉 Полная структура модели Qwen3-VL-8B-Thinking-FP8 готова!"